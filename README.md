...
btrade (a type of whale) is the codename for a boilerplate within Laravel for building 
Cryptocurrency and Forex automated systems.

Utilizing a RESTful API, btrade can be used as a middle-layer for your favorite language
to interface with multiple brokerages and market makers, just add your API keys.

btrade utilizes all the TALib functions implemented in the Trader extenstion for PHP
...
btrade was written and tested on a Mac and I have it running in the cloud on an
