...
class GdaxScalperCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'btrade:gdax_scalper';
    ...
    public function fire()
    {
        ...
        while (1){
            ...
            $sar_stoch_sig = $this->btrade_sar_stoch($this->instrument, $data);
            /**
             ...
             */
            if ($sar_stoch_sig > 1) {
                echo $this->console->colorize("Limit BUY with btrade_sar_stoch\n");
            ...
            if ($sar_stoch_sig > -1) {
                echo $this->console->colorize("Limit SELL with btrade_sar_stoch\n");
                $price_move = $_ticker['price'] + 0.75;
