...
use btrade\Util\Whaleclub;
use btrade\Util\Bitfinex;
use btrade\Util\Candles;
use btrade\Util\Coinbase;
use btrade\Util\Indicators;
use btrade\Util\Oanda;
use btrade\Util\Other;
use btrade\Util\OneBroker;
...
class ExampleUsageCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'btrade:example_usage';
