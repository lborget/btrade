...
namespace btrade\Strategy;
use btrade\Util;

/**
 * Class testStrategy
 * @package btrade\Strategy
 *
 ...
 *
 *              use btrade\Util Ledger class for all buy and sell functions so ledger is properly updated.
 *              use btrade\Util Math class for all math functions not in trader extension.
 *
 */
