...
namespace btrade\Traits;

use btrade\Util\Indicators;

/**
 * Class Strategies
 * @package btrade\Traits
 */
trait Strategies
{
    protected $strategies_all = [
        ...
        ,'btrade_cci_scalper'
        ,'btrade_ema_scalper'
        ,'btrade_ema_stoch_rsi'
        ,'btrade_double_volatility'
        ,'btrade_adx_momentum'
        ,'btrade_base_150'
        ,'btrade_breakout_ma'
        ,'btrade_sar_awesome'
    ...
    protected $strategies_30m = ['btrade_sar_awesome'];

    protected $strategies_1h = [
         'btrade_ema_stoch_rsi'
        ,'btrade_base_150'
        ,'btrade_breakout_ma' // technically this is a 1d, but can be used more
        ,'btrade_cci_ema'
        ,'btrade_ema_adx_macd' // technically a 4h
        ,'btrade_mov_avg_sar'
        ,'btrade_momentum'
        ,'btrade_sma_stoch_rsi'
    ];
     ...
     * @return int
     */
    public function btrade_sar_stoch($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function btrade_awesome_macd($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_adx_smas($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_rsi_macd($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();

        $rsi = $indicators->rsi($pair, $data, 14); // 19 more accurate?
        /** custom macd - not using btrade indicator macd*/
     ...
     * @return int
     */
    public function btrade_sar_rsi($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_stoch_adx($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *         opposite direction
     */
    public function btrade_cci_scalper($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_ema_scalper($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function btrade_ema_stoch_rsi($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function btrade_double_volatility($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function btrade_adx_momentum($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return array|int
     */
    public function btrade_base_150($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function btrade_breakout_ma($pair, $data, $return_full=false)
    {
        $sma20_low  = $this->sma_maker($data['low'], 20);
     ...
     * @return int
     */
    public function btrade_sar_awesome($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_cci_ema($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function btrade_bband_rsi($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_ema_adx_macd($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_mov_avg_sar($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_momentum($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function btrade_sma_stoch_rsi($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function btrade_sar_sma($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
        $price      = array_pop($data['close']);
     ...
     *  @return int
     */
    public function btrade_ema_adx($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function btrade_trend_bounce($pair, $data, $return_full=false)
    {
        // custom bbands
     ...
     *  @return int
     */
    public function btrade_5th_element($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function btrade_powerranger($pair, $data, $return_full=false)
    {
     ...
     *  @return int
     */
    public function btrade_famamama($pair, $data, $return_full=false)
    {
